export const ruPages = {
  orders: {
    ...
    operations: {
      ...
      actions: {
        ...
        flag: "На контроль",
        unflag: "Снять с контроля",
        flagPending: "Обновление отметки контроля...",
      },
      success: {
        status: "Статус заказа обновлен.",
        mechanic: "Механик назначен.",
        flagged: "Заказ поставлен на контроль.",
        unflagged: "Заказ снят с контроля.",
      },
    ...
    cards: {
      ...
      actionsText:
        "Здесь запускаются смена статуса, назначение механика, отметка контроля и переход в детали заказа.",
    },
  },
  ordersCreate: {
    eyebrow: "Создание",
    title: "Создать заказ",
    description: "Создание сервисного заказа: клиент, автомобиль, время визита и стартовые работы.",
    sections: {
      customer: "Клиент",
      vehicle: "Автомобиль",
  ...
  appointments: {
    ...
    description: "Планирование сервисных визитов, распределение слотов механиков и конвертация записей в заказы.",
    toolbar: {
  ...
  orderDetails: {
    ...
    summary: {
      ...
      flagged: "Контроль",
      flaggedYes: "На контроле",
      flaggedNo: "Не на контроле",
    },
    customer: {
      name: "Клиент",
      phone: "Телефон",
  ...
  vehicles: {
    ...
    description: "Поиск автомобилей, таблица реестра и переход к сервисной истории.",
  ...
  vehicleDetails: {
    ...
    description: "Детальная информация об автомобиле, таймлайн сервисной истории и связанные заказы.",
  ...
  analytics: {
    ...
    description:
      "Периодный анализ динамики заказов, структуры работ и загрузки механиков за выбранный диапазон.",
    states: {
