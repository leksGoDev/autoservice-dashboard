...
const activeRangeButtonClass =
  "border-[rgba(107,164,255,0.4)] bg-[rgba(107,164,255,0.2)] text-xs font-semibold text-[var(--color-text-primary)]";
...
export const MechanicsRegistryHeader = ({
  ...
  return (
    <header className="grid gap-2.5 rounded-2xl border border-[var(--color-border)] bg-[rgba(27,33,48,0.9)] p-6">
      ...
      <form className="mt-2 grid items-end gap-2.5 md:grid-cols-[minmax(260px,1fr)_auto]" onSubmit={onSearchSubmit}>
        <label
          htmlFor="mechanics-search"
          className="text-xs font-semibold text-[var(--color-text-secondary)] md:col-span-full"
        >
