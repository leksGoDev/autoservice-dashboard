...
export const VehicleDetailsContent = ({ model }: VehicleDetailsContentProps) => {
  ...
  if (model.isLoading) {
    return (
      <section className="rounded-2xl border border-[rgba(154,164,178,0.18)] bg-[rgba(27,33,48,0.9)] px-4 py-4 text-[var(--color-text-secondary)]">
  ...
  if (model.isError) {
    return (
      <section className="grid gap-3 rounded-2xl border border-[rgba(239,68,68,0.4)] bg-[rgba(27,33,48,0.9)] px-4 py-4 text-[#fecaca]">
