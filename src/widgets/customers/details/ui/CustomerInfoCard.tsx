  ...
  return (
    <article className="grid gap-4 rounded-2xl border border-[var(--color-border)] bg-[rgba(27,33,48,0.9)] p-4">
      ...
      <dl className="grid gap-3 sm:grid-cols-2">
        ...
        <div className="grid gap-1">
          <dt className="m-0 text-[11px] uppercase tracking-[0.03em] text-[var(--color-text-secondary)]">{t("pages.customerDetails.labels.phone")}</dt>
          <dd className="m-0">{customer.phone}</dd>
        </div>
        <div className="grid gap-1">
          <dt className="m-0 text-[11px] uppercase tracking-[0.03em] text-[var(--color-text-secondary)]">{t("pages.customerDetails.labels.email")}</dt>
        ...
        <div className="grid gap-1">
          <dt className="m-0 text-[11px] uppercase tracking-[0.03em] text-[var(--color-text-secondary)]">{t("pages.customerDetails.labels.lastVisit")}</dt>
