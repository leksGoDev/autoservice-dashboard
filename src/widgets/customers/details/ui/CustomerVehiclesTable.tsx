            ...
            <tbody>
              {rows.map((vehicle) => (
                <tr key={vehicle.id} className="transition-colors hover:bg-[#20283a]">
                  ...
                  <td className={tableBodyCellClassName}>{vehicle.vin}</td>
                  <td className={tableBodyCellClassName}>{vehicle.make}</td>
                  <td className={tableBodyCellClassName}>{vehicle.model}</td>
                  <td className={tableBodyCellClassName}>{vehicle.year}</td>
                </tr>
              ))}
            </tbody>
          </table>
